...
const calendarClockMessageContract = new Set([
  ...
  "CALENDAR_CLOCK_SET_DAY_PREVIEW",
...
assert.match(overlaySource, /setCalendarClockSettingsTab\(button\.dataset\.ccSettingsTab\)/);
assert.match(overlaySource, /button\.setAttribute\("aria-pressed", String\(button\.dataset\.ccMode === calendarClockState\.mode\)\)/);
