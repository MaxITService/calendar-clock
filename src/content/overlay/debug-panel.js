...
function getDebugWindowPayload(displayWindow) {
  return {
    ...
    eventLabelPlacement: calendarClockState.eventLabelPlacement,
    eventLabelFlyoutVariant: calendarClockState.eventLabelFlyoutVariant,
